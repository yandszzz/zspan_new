...
if __name__ == '__main__':
    ...
    mat_path = "/home/zds/CODE3070/ZS-Pan_test0716/result/wv3"
    FR = sio.loadmat(os.path.join(mat_path, '19.mat'))
    I_GS = sio.loadmat(os.path.join(mat_path, '19.mat'))['I_SR'].transpose(1, 0, 2) / 65535.0
